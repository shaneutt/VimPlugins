...
" Local variables
    let s:SqlitePath = 'c:\Tools\sqlite3.exe'
...
" Commands
    ...
    " Open in firefox
        com! -nargs=1 SVFirefox exe 'silent ! C:\Tools\FirefoxPortable\App\Firefox\firefox.exe "file:///' . substitute(<args>, '\', '/', 'g') . '"'
" Local Functions
    " norm zzMzrzrk
                        ...
                        " Add some tags and CSS style for the table at the beginning of the file and "press" ESC (to do that, ctrl+q then ESC)
                            exe 'norm ggI<HTML>
                                        \<HEAD>
                                            ...
                                            \<STYLE>td { border: 1px solid #9CC2E5; font-family: calibri; font-size: 10px; }
